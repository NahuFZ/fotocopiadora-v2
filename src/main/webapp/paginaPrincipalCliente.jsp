...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-5">
		<div class="container">
			...
			<a class="navbar-brand fw-bold"><i
				class="bi bi-printer-fill me-2"></i>Fotocopiadora</a>

			<%-- Lado derecho: Nombre del usuario y cerrar sesión --%>
			<div class="navbar-text">
				<span class="text-white mx-3">¡Hola, <strong><%=nombreCliente%></strong>!
				</span>
			...
			<div class="col-md-5 col-lg-4">
				<div class="card action-card shadow-sm border-0 text-center p-4">
					<div class="card-body">
						...
						<p class="card-text text-muted mb-4">Sube tus archivos PDF o
							imágenes, elige la cantidad de copias y cuándo retirarlas.</p>
			...
			<div class="col-md-5 col-lg-4">
				<div class="card action-card shadow-sm border-0 text-center p-4">
					<div class="card-body">
						...
						<p class="card-text text-muted mb-4">Revisa el estado de tus
							trabajos, descarga tus archivos o cancela pedidos pendientes.</p>
